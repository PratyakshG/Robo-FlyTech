...
export const getProductWithOffer     = (id)     => api.get(`/offers/product/${id}`);
...
export const getAdminHeroSlides    = ()          => api.get('/hero-slides/all');
...
export const updateOrderShipping = (id, shippingPrice) => api.put(`/admin/orders/${id}/shipping`, { shippingPrice });
export const getCustomers = () => api.get('/admin/customers');
export const getCustomerDetails = (id) => api.get(`/admin/customers/${id}`);
